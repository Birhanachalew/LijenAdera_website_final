    ...
    <div className="flex w-full flex-wrap justify-center">
      <div className="w-[22rem] shadow-md px-4 pt-8 border border-[#CDEDEA] rounded-md mx-4 my-4 inset-0 transition duration-300 ease-in-out transform hover:scale-105 hover:bg-gradient-to-l hover:from-[#149895] hover:to-transparent">
        ...
        <p className="text-[#2D3748] mb-12">
          ልጄን አደራ አስጠኚ አገናኚ ድርጅት ከተለያዩ ዩንቨርሲቲዎች የተመረቁ እና ልምድ ያላቸው መምህራንን በቀጥታ ወደ ቤትዎ 
      ...
      <div className="w-[22rem] shadow-md px-4 pt-8 border border-[#CDEDEA] rounded-md mx-4 my-4 inset-0 transition duration-300 ease-in-out transform hover:scale-105 hover:bg-gradient-to-l hover:from-[#149895] hover:to-transparent">
        ...
        <p className="text-[#2D3748] mb-12">
          ለብሔራዊ ፈተና፣ ለዩንቨርሲቲ መግቢያ እና ለክፍል ፈተናዎች ለማዘጋጀት የተለየ የማስተማር እቅድ እናዘጋጃለን።
...
export function TestimonialsParents() {
  ...
  const feedbackParents = [
    ...
    },
    {
      id: "parent-2",
      content:
        "ልጄን አደራዎች በጣም አመሰግናለው በጣም ጥሩ ሰው ነው ያገኘሑት ከልጄ ጋርም በደንብ ተግባብተዋል እግዚአብሔር ይስጥልኝ ።",
      name: "ሳምራዊት",
      title: "ወላጅ",
    },
    {
...
export function TestimonialsTutors() {
  ...
  const feedbackTutors = [
    ...
    },
    {
      id: "tutor-3",
      content:
        "ሰላም ጤና ይስጥልኝ።  ልጄን አደራ አስጠኚ ቡድን በጣም አሪፍ አፈጻጸም ያለው እና ምርጥ ቤተሰብ ያለው ድርጅት ነው፣ ስለዚህ በዚህ ቀጥሉ።",
      name: "በላይሁን",
      title: "አስጠኚ",
    },
    {
