...
const Process = () => {
  const steps = [
    ...
    },
    {
      ...
      body: "ለተማሪው ብቻ የተስማማ የመማሪያ እቅድ እናዘጋጃለን፣ ይህም የደከሙበትን የትምህርት አይነቶች ለማሻሻልና ጠንካራ የሆኑባቸዉን የትምህርት አይነቶች ለማበረታታት ይረዳል። ",
    },
    {
      title: "ትምህርት መጀመር እና ክትትል (Start & Monitor Progress)",
      body: "ትምህርቱ በተስማሚ ጊዜ ይጀመራል፣ እኛም በቀጥታ ሂደቱን እንከታተላለን፣ ከወላጆች ጋር ተደጋጋሚ ግንኙነት እናደርጋለን። ",
    },
    {
